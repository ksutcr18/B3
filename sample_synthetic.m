...
range0 = [-1, 1];
range1 = [-10, 10];
f = samplerSynthetic(m0, m1, sigma0, sigma1, range0, range1);
...
save(filename, 'dataset_name', 'n_corruption_levels', 'n_trials_per_corruption_level', 'n_resamples_per_trial', 'n_resamples_per_corruption_level', 'B', 'nT', 'nV', 's_true', 'p0', 'p', 'm0', 'm1', 'sigma0', 'sigma1', 'range0', 'range1', 'nprocesses', 'time', 'notes', 'git')